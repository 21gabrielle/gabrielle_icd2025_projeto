...
dados_tidy <- dados %>%
  pivot_longer(cols = t1:t4, names_to = "trimestre", values_to = "vendas")
...
investimentos_tidy <- investimentos_marketing %>%
  pivot_longer(cols = Jan:Mar , names_to = "mes", values_to = "investimento")
