...
- No relatório financeiro (relatorio_financeiro), a venda com maior valor_total estará na primeira linha da tabela, pois os dados foram ordenados com arrange(desc(valor_total)).

2. O que acontece com as vendas de produtos não cadastrados?

- Caso algum produto vendido não esteja na tabela de produtos, ele aparecerá com NA nas colunas nome_produto e preco_unitario. Isso indica que o produto não está corretamente registrado no sistema.

3. Como este relatório poderia ajudar na tomada de decisões comerciais?

- Identificando vendas sem produtos cadastrados, a equipe pode corrigir falhas no sistema de estoque.
- Com base nas vendas de maior valor, é possível definir estratégias promocionais e ajustar preços.
- O relatório também pode ajudar a prever padrões de demanda e melhorar o planejamento de compras.
